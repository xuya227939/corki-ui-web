            ...
            <div styleName="layout">
                ...
                <div styleName="layout-hero">
                    ...
                    <div>
                        <div styleName="markdown">
                            <p>基于 Ant Design 设计体系的 React UI 组件库，主要用于研发企业级中后台产品</p>
                        </div>
                    </div>
                    <button type="button" onClick={() => history.push('/components/introduce')}>快速上手</button>
                </div>
                ...
                <div styleName="layout-content">
                    ...
                    <div styleName="code-block">
                        <pre styleName="prism-code">
                            ...
                            <div styleName="token-line">
                                <span styleName="token plain">$ </span>
                                <span styleName="token plain">git clone https://github.com/Cherry-Team/corki-ui-web.git </span>
                ...
                <footer styleName="layout-footer">
                    ...
                    <p>
                        ...
                        <br />
                        <a href="http://www.beian.miit.gov.cn/">备案号：湘ICP备18013456号-2</a>
                    </p>
                </footer>
            </div>
        );
